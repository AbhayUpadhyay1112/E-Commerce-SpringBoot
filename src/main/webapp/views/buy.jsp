    ...
    <div class="form-container">
      <div class="personal-information">
        ...
        <p>Product name : <%= request.getParameter("name") %></p>
          ...
          <input id="column-left" type="text" name="expiry" placeholder="MM / YY" minlength="5" maxlength="5" pattern="[0-9]*"required="required"/>
          <input id="column-right" type="text" name="cvv" minlength="3" maxlength="3" pattern="[0-9]*" placeholder="CVV" required="required"/>
